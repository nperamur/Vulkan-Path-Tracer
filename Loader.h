...
class Loader {
    ...
    public: Model load(std::vector<float> vertices, std::optional<std::vector<uint32_t>> indices, std::optional<std::vector<float>> normals, vk
                       ::raii::Device &device, vk::raii::PhysicalDevice &physicalDevice);
