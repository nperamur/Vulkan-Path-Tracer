...
namespace RTShaderSlots {
    ...
    inline constexpr DescriptorBinding rtOutput = {.set = 0, .binding = 5};
    inline constexpr DescriptorBinding materialsBuffer = {.set = 0, .binding = 6};
    inline constexpr DescriptorBinding triangleCdfBuffer = {.set = 0, .binding = 7};
    inline constexpr DescriptorBinding lightCdfBuffer = {.set = 0, .binding = 8};
    inline constexpr DescriptorBinding lightDataBuffer = {.set = 0, .binding = 9};
    inline constexpr DescriptorBinding emissiveVerticesBuffer = {.set = 0, .binding = 10};
...
namespace ForwardPassShaderSlots {
    ...
    inline constexpr DescriptorBinding forwardPassUBO = {.set = 1,.binding = 0};
